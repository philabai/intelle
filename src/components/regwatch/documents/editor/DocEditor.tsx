...
export function DocEditor({
  ...
  // Note: the multi-page "Word Print Layout" rendering in the editor has
  // been retired in favour of a real PDF preview on the doc detail page
  // (DocPdfPreview + getDocumentPreviewPdf). The editor itself is now a
  // plain centered column with horizontal page-break dividers — fast to
  // edit, no measurement hacks. Authors compose here; verify in /[id].
