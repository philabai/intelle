            ...
            <div className="p-6 rounded-xl bg-card-bg border border-card-border">
              ...
              <div className="flex flex-wrap gap-2">
                {industry.standards.map((s) => (
                  <span key={s} className="px-3 py-1.5 rounded-full bg-brand-teal/10 text-brand-teal text-sm">{s}</span>
                ))}
              </div>
            </div>
            <div className="p-6 rounded-xl bg-card-bg border border-card-border">
              ...
              <div className="flex flex-wrap gap-2">
                {industry.clients.map((c) => (
                  <span key={c} className="px-3 py-1.5 rounded-full bg-brand-blue/10 text-brand-blue text-sm">{c}</span>
                ))}
              </div>
            </div>
          </div>
